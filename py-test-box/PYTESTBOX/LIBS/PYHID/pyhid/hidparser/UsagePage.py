...
# ------------------------------------------------------------------------------
"""
@package pyhid.hidparser.usagepage

@brief  HID parser usage page class
...
class UsagePage(_Enum):
    ...
    def find_usage_page(cls, value):
        ...
        raise NotImplementedError("Yet to support Vendor defined usage pages 0x{:04X}".format(value))
