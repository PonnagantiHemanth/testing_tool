...
# ------------------------------------------------------------------------------
"""
:package: pyraspi.services.kosmos.config.keymatrix.honolulu
:brief: Honolulu keyboard key layout definition
...
# implementation
# ----------------------------------------------------------------------------
class HonoluluBLEPROKeyMatrix(CommonKeyMatrix):
    """
    Configure the key matrix layout

    Key matrix map
    https://docs.google.com/spreadsheets/d/11L8FCR8wH-8mNYtO_vh3zCtNgkuNUyycK1RMvpoOphE/view
    """
    KEYS = {
        # ROW 0
        ...
        KEY_ID.NEXT_TRACK: (KbdMatrix.COL_7, KbdMatrix.ROW_0),
        ...
        KEY_ID.MULTI_PLATF_SEARCH_SPOTLIGHT: (KbdMatrix.COL_11, KbdMatrix.ROW_0),
        # Col_12, Row_0: N/A, EU Key
        ...
        # Col_12, Row_5: N/A, None US key

        # ROW 6
        KEY_ID.CALCULATOR: (KbdMatrix.COL_0, KbdMatrix.ROW_6),
        KEY_ID.SHOW_DESKTOP: (KbdMatrix.COL_1, KbdMatrix.ROW_6),
        # Col_2, Row_5: N/A
        ...
        KEY_ID.KEYBOARD_VOLUME_UP: (KbdMatrix.COL_1, KbdMatrix.ROW_7),
        KEY_ID.KEYBOARD_VOLUME_DOWN: (KbdMatrix.COL_2, KbdMatrix.ROW_7),
        KEY_ID.SCREEN_LOCK: (KbdMatrix.COL_3, KbdMatrix.ROW_7),
        ...
        KEY_ID.PLAY_PAUSE: (KbdMatrix.COL_10, KbdMatrix.ROW_7),
        ...
        KEY_ID.MISSION_CTRL_TASK_VIEW: (KbdMatrix.COL_2, KbdMatrix.ROW_8),
        KEY_ID.KEYBOARD_Z: (KbdMatrix.COL_3, KbdMatrix.ROW_8),
        KEY_ID.KEYBOARD_I: (KbdMatrix.COL_4, KbdMatrix.ROW_8),
        ...
        KEY_ID.KEYBOARD_CAPS_LOCK: (KbdMatrix.COL_9, KbdMatrix.ROW_8),
        ...
        KEY_ID.DICTATION: (KbdMatrix.COL_1, KbdMatrix.ROW_9),
        KEY_ID.KEYBOARD_C: (KbdMatrix.COL_2, KbdMatrix.ROW_9),
        KEY_ID.KEYBOARD_G: (KbdMatrix.COL_3, KbdMatrix.ROW_9),
        KEY_ID.KEYBOARD_LOCKING_NUM_LOCK: (KbdMatrix.COL_4, KbdMatrix.ROW_9),
        KEY_ID.PREV_TRACK: (KbdMatrix.COL_5, KbdMatrix.ROW_9),
        KEY_ID.KEYBOARD_EQUAL_AND_PLUS: (KbdMatrix.COL_6, KbdMatrix.ROW_9),
        KEY_ID.APP_SWITCH: (KbdMatrix.COL_7, KbdMatrix.ROW_9),
        ...
        KEY_ID.KEYPAD_8_AND_UP_ARROW: (KbdMatrix.COL_11, KbdMatrix.ROW_9),
        KEY_ID.KEYPAD_5: (KbdMatrix.COL_12, KbdMatrix.ROW_9),
    }
    ...
    FN_KEYS = {
        ...
        KEY_ID.KEYBOARD_F4: KEY_ID.APP_SWITCH,
        ...
        KEY_ID.KEYBOARD_F9: KEY_ID.PREV_TRACK,
        KEY_ID.KEYBOARD_F10: KEY_ID.PLAY_PAUSE,
        KEY_ID.KEYBOARD_F11: KEY_ID.NEXT_TRACK,
        KEY_ID.KEYBOARD_F12: KEY_ID.KEYBOARD_MUTE,
        KEY_ID.FN_KEYBOARD_BACKSPACE: KEY_ID.KEYBOARD_BACKSPACE,
        KEY_ID.FN_LOCK: KEY_ID.KEYBOARD_ESCAPE,
        KEY_ID.KEYBOARD_SCROLL_LOCK: KEY_ID.SHOW_DESKTOP,
        KEY_ID.KEYBOARD_MENU: KEY_ID.MULTI_PLATF_SEARCH_SPOTLIGHT,
    }
# end class HonoluluBLEPROKeyMatrix
