...
# ------------------------------------------------------------------------------
"""
:package: pyraspi.services.kosmos.config.keymatrix.pamir
:brief: Pamir keyboard key layout definition
...
# implementation
# ----------------------------------------------------------------------------
class PamirKeyMatrix(CommonKeyMatrix):
    """
    Configure the US key matrix layout

    Key matrix map
    https://drive.google.com/file/d/1rqpofveWjXNTY7GySH52AgamCc0ogTHI/view
    """
    LAYOUT = 'US'
    HAS_KEYPAD = True
    ...
    KEYS = {
        ...
        KEY_ID.KEYBOARD_F11: (KbdMatrix.COL_7, KbdMatrix.ROW_0),
        ...
        KEY_ID.KEYBOARD_F12: (KbdMatrix.COL_6, KbdMatrix.ROW_5),
        ...
        KEY_ID.KEYBOARD_F2: (KbdMatrix.COL_8, KbdMatrix.ROW_6),
        ...
        KEY_ID.KEYBOARD_F1: (KbdMatrix.COL_8, KbdMatrix.ROW_7),
        KEY_ID.KEYBOARD_T: (KbdMatrix.COL_9, KbdMatrix.ROW_7),
        KEY_ID.KEYBOARD_F10: (KbdMatrix.COL_10, KbdMatrix.ROW_7),
        KEY_ID.KEYBOARD_F7: (KbdMatrix.COL_11, KbdMatrix.ROW_7),
        KEY_ID.KEYPAD_ENTER: (KbdMatrix.COL_12, KbdMatrix.ROW_7),

        # ROW 8
        KEY_ID.PLAY_PAUSE: (KbdMatrix.COL_0, KbdMatrix.ROW_8),
        KEY_ID.KEYBOARD_MUTE: (KbdMatrix.COL_1, KbdMatrix.ROW_8),
        KEY_ID.KEYBOARD_VOLUME_DOWN: (KbdMatrix.COL_2, KbdMatrix.ROW_8),
        ...
        KEY_ID.SCREEN_CAPTURE: (KbdMatrix.COL_8, KbdMatrix.ROW_8),
        ...
        KEY_ID.KEYBOARD_F3: (KbdMatrix.COL_2, KbdMatrix.ROW_9),
        ...
        KEY_ID.KEYBOARD_F5: (KbdMatrix.COL_1, KbdMatrix.ROW_10),
        ...
        KEY_ID.KEYBOARD_F9: (KbdMatrix.COL_5, KbdMatrix.ROW_10),
        KEY_ID.KEYBOARD_EQUAL_AND_PLUS: (KbdMatrix.COL_6, KbdMatrix.ROW_10),
        KEY_ID.KEYBOARD_F4: (KbdMatrix.COL_7, KbdMatrix.ROW_10),
        KEY_ID.KEYBOARD_F8: (KbdMatrix.COL_8, KbdMatrix.ROW_10),
        KEY_ID.KEYBOARD_3: (KbdMatrix.COL_9, KbdMatrix.ROW_10),
        KEY_ID.KEYBOARD_F6: (KbdMatrix.COL_10, KbdMatrix.ROW_10),
...
# end class PamirKeyMatrix


class PamirUkLayoutKeyMatrix:
    """
    ...
    KEYS = PamirKeyMatrix.KEYS.copy()
    FN_KEYS = PamirKeyMatrix.FN_KEYS.copy()

    del KEYS[KEY_ID.KEYBOARD_BACKSLASH_AND_PIPE]
    KEYS[KEY_ID.KEYBOARD_NO_US_45] = (KbdMatrix.COL_12, KbdMatrix.ROW_5)
# end class PamirUkLayoutKeyMatrix


class PamirJpnLayoutKeyMatrix:
    """
    ...
    del KEYS[KEY_ID.KEYBOARD_BACKSLASH_AND_PIPE]
# end class PamirJpnLayoutKeyMatrix
