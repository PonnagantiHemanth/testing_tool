...
# -*- coding: utf-8 -*-
"""
:package: codegenerator.generator.functionality
:brief: Generator for functionality class
...
# implementation
# ----------------------------------------------------------------------------------------------------------------------
class FunctionalityGenerator(CommonFileGenerator):
    """
    Generate ``Functionality`` file
    """

    @staticmethod
    def _get_dictionary():
        """
        Get the ``Functionality`` related inputs in dictionary format
        ...
        body = []
        for test_case_info in AutoInput.TEST_CASES_INFO_FUNCTIONALITY:
            body.append(ReqResGenerator.get_test_case_item(test_case_info, "Functionality"))
        # end for
        ...
        dictionary["ImportStructure"] = [
            AutoInput.get_import_text(Template(FunctionalityTemplate.IMPORT_BASE_CLASS).substitute(dictionary))]

        dictionary["ClassStructure"] = Template(FunctionalityTemplate.CLASS_STRUCTURE).substitute(dict(
            Type="functionality",
            TestCase=dictionary["FeatureNameTitleCaseWithoutSpace"] + "FunctionalityTestCase",
    ...
    def __init__(self):
        ...
        # get input dictionary specific to functionality file
    ...
    # end def process
# end class FunctionalityGenerator
